...
config = {
         'username': 'mycassanda-db',

         'password': 'KfB6foMZW2mzdK8i2vLrmlxPtA23vdLJfuIrzn3rDzzKJNVOJujoCAVVE095DTR7lTKdK74ufe2TH6TFQDEbWA==',

         'contactPoint': 'mycassanda-db.cassandra.cosmos.azure.com',
